...
void MainWindow::setupLogarithmicDemo(QCustomPlot *customPlot) {
  ...
  // make top right axes clones of bottom left axes:
  customPlot->axisRect()->setupFullAxesBox();
  // connect signals so top and right axes move in sync with bottom and left
  // axes:
  connect(customPlot->xAxis, SIGNAL(rangeChanged(QCPRange)), customPlot->xAxis2,
          SLOT(setRange(QCPRange)));
  connect(customPlot->yAxis, SIGNAL(rangeChanged(QCPRange)), customPlot->yAxis2,
...
void MainWindow::setupRealtimeDataDemo(QCustomPlot *customPlot) {
  ...
  // setup a timer that repeatedly calls MainWindow:::
...
//  fermatSpiral2->setBrush(QBrush(QColor(255, 120, 0, 30)));
  QRadialGradient radialGrad(QPointF(395, 375), 120);
  radialGrad.setColorAt(1, QColor(170, 20, 240, 100));
  radialGrad.setColorAt(0.9, QColor(20, 10, 255, 40));
  radialGrad.setColorAt(0.8, QColor(120, 20, 240, 10));
